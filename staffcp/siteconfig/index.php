		...
		<div class='container-fluid'>
            <div class='row gy-4'>
              <div class='col-lg-12'>
				...
				$sql = "SELECT id, site_dl_section, site_rage_section, site_altv_section, site_fivem_section, site_redm_section, site_online, site_name, site_teamspeak, site_gservername, site_gserverip, site_gserverport from config ORDER by id DESC LIMIT 1";
				$result = $conn->query($sql);
